...
// ─── InputPanel — defined at MODULE LEVEL so identity is stable ───────────────
...
function InputPanel({
  ...
  system, setSystem, showSystem, setShowSystem,
  loading, onRun,
}: InputPanelProps) {
  return (
...
// ─── OutputPanel — defined at MODULE LEVEL ─────────────────────────────────────
...
function OutputPanel({ trace, loading, error, response, rawJson, showRaw, setShowRaw }: OutputPanelProps) {
  return (
...
export default function RouterPage() {
  ...
  const inputProps: InputPanelProps = {
    model, setModel, prompt, setPrompt,
    system, setSystem, showSystem, setShowSystem,
    loading, onRun: handleRun,
  }

  const outputProps: OutputPanelProps = {
    trace, loading, error, response,
    rawJson, showRaw, setShowRaw,
  }
